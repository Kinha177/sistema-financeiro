...
class LivroDiarioView(QWidget):
    ...
    def _build_header(self) -> QWidget:
        ...
        ly.addWidget(QLabel("Livro Diário", objectName="pageTitle"))
        ly.addWidget(QLabel("Registro cronológico de todos os lançamentos", objectName="pageSubtitle"))
        return h
    ...
    def _build_table(self) -> QTableWidget:
        cols = ["Data", "Lançamento N°", "Histórico", "Conta Débito", "Conta Crédito", "Valor"]
